...
export const helpContent = {
    ...
    lensSelection: {
        ...
        domainSelection: {
        header: 'Analysis Domain Selection',
        body: (
            <SpaceBetween size="xxs">
                <Box variant="p">
                    Select which resilience domain to analyze your infrastructure against:
                </Box>
                <ul>
                    <li><strong>SaaS Resilience:</strong> Best practices for Software-as-a-Service applications focusing on multi-tenancy, scalability, and service reliability</li>
                    <li><strong>EKS Resilience:</strong> Container orchestration resilience patterns for Amazon Elastic Kubernetes Service workloads</li>
                    <li><strong>Serverless Resilience:</strong> Resilience patterns for serverless architectures using AWS Lambda, API Gateway, and other serverless services</li>
                    <li><strong>Data Resilience:</strong> Data protection, backup, recovery, and consistency patterns for databases and data storage</li>
                    <li><strong>Network Resilience:</strong> Network architecture patterns for high availability, fault tolerance, and disaster recovery</li>
                </ul>
                <Box variant="p">
                    Each domain provides specialized best practices and recommendations tailored to that specific area of resilience. The analysis will focus on patterns and practices most relevant to your selected domain.
                </Box>
                <Box variant="h4">Why use domain-specific analysis?</Box>
                <Box variant="p">
                    Domain-specific analysis provides more targeted and actionable recommendations. For example, SaaS Resilience focuses on tenant isolation and service boundaries, while Data Resilience emphasizes backup strategies and data consistency patterns.
                </Box>
            </SpaceBetween>
        )
    },
