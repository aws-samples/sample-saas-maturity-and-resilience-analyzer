...
export class AnalyzerController {
  ...
  async analyze(
    ...
    try {
      ...
      // If workloadId is provided, mark it as protected
      let workloadIds: Record<string, { id: string; protected: boolean; lastUpdated?: string }> | undefined;
      if (analyzeRequest.workloadId && !analyzeRequest.isTempWorkload) {
        workloadIds = {
          [analyzeRequest.selectedDomain]: {
